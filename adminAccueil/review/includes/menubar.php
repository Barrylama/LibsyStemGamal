  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="../memory/memory_consultation.php"><i class="fa fa-circle-o"></i> Consultations</a></li>
          <li><a href="../memory/memory_borrow.php"><i class="fa fa-circle-o"></i> Emprunts</a></li>
        </ul>
      </li>
      <li class="treeview">
        <a href="#">
        ...
        <ul class="treeview-menu">
          <li><a href="review_consultation.php"><i class="fa fa-circle-o"></i> Consultations</a></li>
          <li><a href="review_borrow.php"><i class="fa fa-circle-o"></i> Emprunts</a></li>
        </ul>
      </li>
        </ul>
      </li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="reviewStatistique.php"><i class="fa fa-circle-o"></i> Statistiques</a></li>
        </ul>
      </li>
      <li class="treeview">
        <a href="#">
