    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Ajouter un nouveau lecteur Personnel Universitaire</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="reader_personnel_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="Faculte" class="col-sm-3 control-label">Faculté</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Modification d'un lecteur Personnel Universitaire</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="reader_personnel_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_reader_faculte" class="col-sm-3 control-label">Faculté</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_reader_faculte" name="reader_faculte" required>
                    </div>
                </div>

                <div class="form-group">
                    <label for="edit_Poste" class="col-sm-3 control-label">Poste</label>
                    <div class="col-sm-9">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="reader_personnel_delete.php">
                <input type="hidden" class="readId" name="reader_id">
...
<div class="modal fade" id="edit_photo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="reader_personnel_edit_photo.php" enctype="multipart/form-data">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              	<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Vue d'un lecteur Personnel Universitaire</b></h4>
          	</div>
          	<div class="modal-body">
             <div class="row">
              <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="view_Faculte" name="Faculte" disabled>
                    </div>
                </div>
                <div class="form-group">
                    <label for="Poste" class="col-sm-3 control-label">Poste</label>
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="view_Poste" name="Poste" disabled>
                    </div>
                </div>
            </div>
            <div class="col-md-7">
