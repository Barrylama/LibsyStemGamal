...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box" style="background-color: #72C938; color: #fff;">
        ...
        ?>
            <p>Livres total <br> Disponible</p>
        </div>
        <div class="icon">
...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box" style="background-color: #38C946; color: #fff;">
        ...
        echo "<h3>".$query->num_rows."</h3>"
        ?>
            <p>Livres total <br> consultés </p>
        </div>
        <div class="icon">
        <img src="../icons/consultant.png" alt="Votre Icône" />
        </div>
        <a href="../book/book_consultation.php" class="small-box-footer">Plus d'info <i class="fa fa-arrow-circle-right"></i></a>
    </div>    
...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box" style="background-color: #38BBC9; color: #fff;">
        <div class="inner">
        <?php
        $sql = "SELECT * FROM book_borrow WHERE status IS NULL";
        $query = $conn->query($sql);
        $row = $query->fetch_assoc();
        echo "<h3>".$query->num_rows."</h3>"
        ?>
            <p>Total de Livres <br> en emprunts</p>
        </div>
        <div class="icon">
        <img src="../icons/book.png" alt="Votre Icône" />
        </div>
...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box" style="background-color: #38BBC9; color: #fff;">
        <div class="inner">
        <?php
        $sql = "SELECT * FROM book_consultation WHERE status IS NULL";
        $query = $conn->query($sql);
        $row = $query->fetch_assoc();
        echo "<h3>".$query->num_rows."</h3>"
        ?>
            <p>Total de Livres <br> en consultation</p>
        </div>
        <div class="icon">
...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box" style="background-color: #38C98F; color: #fff;">
        <div class="inner">
        <?php
        $sql = "SELECT * FROM book_borrow WHERE borrow_book_date = CURDATE()";
        $query = $conn->query($sql);
        $row = $query->fetch_assoc();
        echo "<h3>".$query->num_rows."</h3>"
        ?>
            <p>Total de Livres <br> empruntés aujourd'hui</p>
        </div>
        <div class="icon">
...
<div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box" style="background-color: #38C946; color: #fff;">
        <div class="inner">
        <?php
        $sql = "SELECT * FROM book_consultation WHERE consultation_book_date = CURDATE()";
        $query = $conn->query($sql);
        $row = $query->fetch_assoc();
        echo "<h3>".$query->num_rows."</h3>"
        ?>
            <p>Total de Livres <br> consultés aujourd'hui</p>
        </div>
        <div class="icon">
        <img src="../icons/reader.png" alt="Votre Icône" />
        </div>
    ...
    <div class="small-box" style="background-color: #72C938; color: #fff;">
      ...
      <?php
        ...
        $sql = "SELECT COUNT(*) AS total FROM (
          SELECT * FROM book_borrow WHERE DATE(return_book_date) = '$date'
          UNION ALL
          SELECT * FROM book_consultation WHERE DATE(return_book_date) = '$date'
        ) AS combined_table";
        $query = $conn->query($sql);
        $row = $query->fetch_assoc();
        echo "<h3>".$row['total']."</h3>";
      ?>
        <p>Total de Livres <br> retournés aujourd'hui</p>
      </div>
      <div class="icon">
...
<div class="col-lg-12 col-xs-7">
  <h3 class="card-title">STATISTIQUE SUR LES LIVRES PAR FACULTE</h3>
    <div class="card-group">
        <?php
            $sql = "SELECT faculty.name_faculty, COUNT(book.book_id) AS num_book
                    FROM faculty
            ...
            while ($row = $query->fetch_assoc()) 
            {
                ...
                echo "<p class='card-text'>".$row['num_book']." Livres</p>";
                echo "</div>";
    ...
    <div class="card-group">
        <?php
            $sql = "SELECT book_category.name_category_book, COUNT(book.book_id) AS num_book_cat
                    FROM book_category
            ...
            while ($row = $query->fetch_assoc()) 
            {
                ...
                echo "<p class='card-text'>".$row['num_book_cat']." Livres</p>";
                echo "</div>";
                echo "<div class='card-footer'>";
                echo "</div>";
                echo "</div>";
