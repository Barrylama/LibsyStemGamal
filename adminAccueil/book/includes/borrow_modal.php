    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Emprunt d'un livre</b></h4>
          	</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              		<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Consultation d'un livre</b></h4>
          	</div>
          	<div class="modal-body">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><b>Retour Livre...</b></h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="return_consultation_book.php">
                    <input type="hidden" class="consultationBookId" name="consultation_book_id">
...
<!-- Return book -->
<div class="modal fade" id="return-book-btn">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="return_borrow_book.php">
                    <input type="hidden" class="borrowBookId" name="borrow_book_id">
                    <div class="text-center">
                        <p>Retourner le livre</p>
                        <h2 class="return_book bold"></h2>
                    </div>
