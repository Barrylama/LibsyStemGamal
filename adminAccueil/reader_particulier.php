...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Liste des lecteurs Particuliers
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Accueil</a></li>
        <li>Lecteurs</li>
        <li class="active">Liste des lecteurs Particuliers</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="printReaderP.php"  class="btn btn-primary btn-sm btn-flat"><i class="fa fa-print"></i> Impression de la liste des lecteurs</a>
            </div>
            <div class="box-body">
  ...
  <?php include 'includes/reader_particulier_modal.php'; ?>
</div>
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#edit_Profession').val(response.Poste);
      $('#edit_Identite').val(response.Matricule);
      ...
      $('#view_Profession').val(response.Poste);
      $('#view_Identite').val(response.Matricule);
