...
function Header()
{
    ...
    $this->Cell(0, 10, 'Liste complete des etudiants inscrits de l\'uganc ', 0, 1, 'C');
    ...
    // Titres des colonnes
    $header = array('PRENOMS', 'NOMS','FACULTE', 'DEPARTEMENT', 'CLASSES', 'MATRICULES');
    $this->SetFont('Arial', 'B', 10);
    $this->Cell(51, 10, $header[0], 1, 0, 'C');
    $this->Cell(18, 10, $header[1], 1, 0, 'C');
    $this->Cell(40, 10, $header[2], 1, 0, 'C');
    $this->Cell(42, 10, $header[3], 1, 0, 'C');
    $this->Cell(20, 10, $header[4], 1, 0, 'C');
    $this->Cell(25, 10, $header[5], 1, 1, 'C');
}
...
foreach ($data as $row) {
    ...
    $pdf->Cell(40, 7, $row['name_category_reader'], 1, 0, 'C');
    $pdf->Cell(42, 7, $row['Departement'], 1, 0, 'C');
    $pdf->Cell(20, 7, $row['Licence'], 1, 0, 'C');
    $pdf->Cell(25, 7, $row['Matricule'], 1, 1, 'C');
}
