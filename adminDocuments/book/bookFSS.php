...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Liste de livres de la faculté de sciences et technique de la santé
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Accueil</a></li>
        <li>Livres</li>
        <li class="active">Liste de livres de la faculté de sciences et technique de la santé</li>
      </ol>
    </section>
    <!-- Main content -->
