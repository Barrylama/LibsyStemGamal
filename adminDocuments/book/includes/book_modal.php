    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Ajout d'un livre</b></h4>
          	</div>
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="category" id="category" required>
                        ...
                        <?php
                          ...
                          while($crow = $query->fetch_assoc()){
                            echo "
                              <option value='".$crow['book_category_id']."'>".$crow['name_category_book']."</option>
                            ";
                          }
                        ?>
                      </select>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              	<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Modification d'un livre</b></h4>
          	</div>
          	<div class="modal-body">
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="faculte" id="edit_faculte" required>
                        <option value="" selected id="sel_faculte_book">- Selectionnez une option -</option>
                        <?php
                          $sql = "SELECT * FROM faculty";
                          $query = $conn->query($sql);
                          while($crow = $query->fetch_assoc()){
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="category" id="edit_category" required>
                        <option value="" selected id="sel_category_book">- Selectionnez une option -</option>
                        <?php
                          $sql = "SELECT * FROM book_category";
                          $query = $conn->query($sql);
                          while($crow = $query->fetch_assoc()){
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              	<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Vue d'un livre</b></h4>
          	</div>
          	<div class="modal-body">
             <div class="row">
              <div class="col-md-5">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="faculte" id="view_faculte" required disabled>
                        <option value="" selected id="view_faculte_book">- Selectionnez une option -</option>
                        <?php
                          $sql = "SELECT * FROM faculty";
                          $query = $conn->query($sql);
                          while($crow = $query->fetch_assoc()){
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select class="form-control" name="category" id="view_category " required disabled>
                        <option value="" selected id="view_category_book" >- Selectionnez une option -</option>
                        <?php
                          $sql = "SELECT * FROM book_category";
                          $query = $conn->query($sql);
                          while($crow = $query->fetch_assoc()){
            ...
            <div class="form-group">
                        ...
                        <div class="col-sm-70">
                            <img src="" alt="Book Cover" id="view_photo" style="width:100%;height:400px;" >
                        </div>
            </div>
