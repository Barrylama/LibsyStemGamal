    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Ajout d'une revue</b></h4>
          	</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Close">
              	<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Modification d'une revue</b></h4>
          	</div>
          	<div class="modal-body">
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="faculte" id="edit_faculte" required>
                        <option value="" selected id="sel_faculte_review">- Selectionnez une option -</option>
                        <?php
                          $sql = "SELECT * FROM faculty";
                          $query = $conn->query($sql);
                          while($crow = $query->fetch_assoc()){
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <select class="form-control" name="category" id="edit_category" required>
                        <option value="" selected id="sel_category_review">- Selectionnez une option -</option>
                        <?php
                          $sql = "SELECT * FROM review_category";
                          $query = $conn->query($sql);
                          while($crow = $query->fetch_assoc()){
...
<div class="modal fade" id="edit_photo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="review_edit_photo.php" enctype="multipart/form-data">
              <input type="hidden" class="reviewId" name="id">
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">Photo de la couverture</label>
